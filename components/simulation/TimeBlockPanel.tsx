              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <h2 id={TITLE_ID} className="font-sans font-bold text-[17px] text-dark leading-snug">
                      {block.title}
                    </h2>
                    <p className="font-sans text-[13px] text-muted mt-0.5">{formatTimeRange(block.timeRange)}</p>
                  </div>
                  <button
                    ref={closeBtnRef}
                    onClick={onClose}
              ...
              <div className="shrink-0 px-6 py-4 border-t border-border flex flex-col gap-3">
                ...
                {isCompleted ? (
                  <button
                    ...
                    className="w-full py-2.5 rounded-btn flex items-center justify-center gap-2
