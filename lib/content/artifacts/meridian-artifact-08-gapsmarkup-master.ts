// Meridian Park artifact 08 - GapsMarkup_Master. Self-contained HTML,
// verbatim from content repo artifacts/artifact_08_GapsMarkup_Master.html. Do not edit the markup.
// Rendered in a sandboxed iframe by components/simulation/HtmlArtifact.tsx.
// Manifest type powerpoint, which the app renders at powerpoint width. Placement: Block 11, Deck review with Marcus, Thursday (master variant, 20 base).

export const meridianArtifact08MasterHtml = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<tr><td>Onboarding re-papering (carried as the separate no-memory theme)</td><td class="c">10 of 20 (50%)</td><td>Re-submit the same entity info and signatories each new fund</td><td>Re-papered up to 4 times for multi-fund investors</td></tr>
</table>
...
<div class="sfoot"><span class="src">Source: investor interview programme, 20 interviews completed to date. Quantification is investor-reported.</span><span class="rt"><span class="draft">Draft</span><span class="conf">Confidential, prepared for Meridian Park</span><span class="pg">3.3</span></span></div>
</div>
...
<div class="cmt"><div class="ch"><span class="cn">2</span><span class="who">Marcus</span><span class="on">Raised by</span></div><p>14 of 20 what? Investors interviewed to date. Put the base on every number, and make each slide stand on its own.</p></div>
