// Project Kestrel artifact 07 - CIM_Markup_Priya. Self-contained HTML,
// verbatim from content repo artifacts/artifact_07_CIM_Markup_Priya.html. Do not edit the markup.
// Rendered in a sandboxed iframe by components/simulation/HtmlArtifact.tsx.

export const artifact07Html = `<!-- artifact 7, Block 6 Tuesday, type powerpoint -->
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Halloran Foods CIM - Executive Summary (Priya markup)</title>
<style>
  :root{
...
<div class="app">
  <div class="toolbar"><span class="dot"></span>
    <b>Halloran_Foods_CIM_ExecSummary.pptx</b> &nbsp; Reviewing &nbsp; 5 comments from Priya (VP)
  </div>
  ...
  <div class="stage">
        ...
        <div class="cols">
          ...
          <div class="col">
            ...
            <ul>
              ...
              <li>National club store program annualizing into next year on already won business <span class="mk">1</span></li>
          ...
          <div class="col">
            ...
            <table class="fin">
              ...
              <tr class="sub"><td class="k">Adjusted EBITDA <span class="mk">3</span></td><td class="v">$19.6M</td></tr>
              <tr><td class="k">Adjusted EBITDA margin</td><td class="v">16.6%</td></tr>
            </table>

            <div class="chartwrap">
              <div class="charttitle">Revenue ($M) <span class="mk">2</span></div>
            ...
            <div class="opp">
              ...
              <ul>
                ...
                <li class="ev">Transaction contemplates an enterprise value of approximately $200 million <span class="mk">5</span></li>
              </ul>
            </div>
    ...
    <!-- ================= COMMENTS RAIL ================= -->
    <div class="rail">
      <div class="rh"><span>Comments &nbsp; Priya, VP</span><span class="n">5</span></div>

      <div class="cmt">
        <div class="av">P</div>
        <div>
          <div class="top"><span class="num">1</span><span class="who">Priya</span><span class="role">VP</span><span class="time">8:41 AM</span></div>
          <div class="txt">Lead with the signed business. The annualization and committed lines are the story, pricing is a lever, not the headline. Reorder so the first thing a buyer sees is the piece they can underwrite.</div>
        </div>
      </div>
      ...
      <div class="cmt">
        <div class="av">P</div>
        <div>
          <div class="top"><span class="num">2</span><span class="who">Priya</span><span class="role">VP</span><span class="time">8:43 AM</span></div>
          <div class="txt">Label the year-2 step as a one-time annualization, not a run rate, or diligence will treat the whole curve as aggressive. Say it before they ask.</div>
        </div>
      </div>
      ...
      <div class="cmt">
        <div class="av">P</div>
        <div>
          <div class="top"><span class="num">3</span><span class="who">Priya</span><span class="role">VP</span><span class="time">8:44 AM</span></div>
          <div class="txt">Every add-back needs its reason on the same page. The owner comp normalization especially, a sponsor will test it first.</div>
        </div>
      </div>
      ...
      <div class="cmt">
        <div class="av">P</div>
        <div>
          <div class="top"><span class="num">4</span><span class="who">Priya</span><span class="role">VP</span><span class="time">8:46 AM</span></div>
          <div class="txt">We need a concentration line here. If the top accounts carry the number, disclose it up front and frame the retention, do not let the buyer find it in the data room.</div>
        </div>
      </div>
      ...
      <div class="cmt">
        <div class="av">P</div>
        <div>
          <div class="top"><span class="num">5</span><span class="who">Priya</span><span class="role">VP</span><span class="time">8:48 AM</span></div>
          <div class="txt">Enterprise value framing is fine at this stage, but tie it to the base case, not the upside, so we are not defending the high number on day one.</div>
        </div>
      </div>
    </div>
  </div>

  <div class="hint">Mock for render-fidelity review only. The red numbered markers on the slide correspond to Priya's numbered comments in the review pane. Not wired to anything.</div>
</div>
</body>
</html>
`
