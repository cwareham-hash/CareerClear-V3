// Project Kestrel artifact — Halloran Foods CIM executive summary (with Danny's
// review comments). Self-contained HTML document, copied VERBATIM from the proven
// fidelity mock; do not edit the markup. Rendered in a sandboxed iframe by
// components/simulation/HtmlArtifact.tsx. Attached to block ib-analyst-kestrel-full-d1-b2.
//
// Drop-in convention for future IB artifacts: add one .ts here exporting the raw
// HTML string, add it to the target block's artifactsHtml map under a number N,
// and place a {{artifact:N}} marker in the block's prose where it should render.

export const halloranCimExecSumHtml = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Halloran Foods CIM - Executive Summary (under review)</title>
<style>
  :root{
    --navy:#1f2a44; --steel:#3e506b; --ink:#20242b; --grey:#595f6b;
    --ltgrey:#e8eaee; --rule:#b88a3e; --paper:#ffffff; --bg:#e6e8ee;
    --gold:#f2c95b; --line:#cdd2db; --cream:#f4f1e8;
  }
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  table.fin td{border:1px solid var(--line);padding:4px 8px;font-size:10.7px}
  ...
  .chart{display:flex;align-items:flex-end;gap:14px;height:78px;padding:0 4px}
  ...
  .opp{background:var(--cream);border:1px solid var(--rule);padding:9px 11px;margin-top:2px}
  .opp .oh{color:var(--navy);font-weight:700;font-size:10.5px;letter-spacing:.5px;margin-bottom:5px}
  .opp li{font-size:10.4px;margin-bottom:5px}
  ...
  .foot-note{font-size:8.4px;font-style:italic;color:var(--grey);line-height:1.3;margin-top:8px;position:relative}
...
<div class="app">
  <div class="toolbar"><span class="dot"></span>
    <b>Halloran_Foods_CIM_ExecSummary.pptx</b> &nbsp; Reviewing &nbsp; 6 comments from Danny (Associate) &nbsp; | &nbsp; Draft, turning tonight
  </div>
  ...
  <div class="stage">
      ...
      <div class="body">
        ...
        <div class="cols">
          ...
          <div class="col">
            ...
            <div class="lbl" style="margin-top:10px">INVESTMENT HIGHLIGHTS <span class="mk">3</span></div>
            <ul>
            ...
            <div class="cust">Customer profile: the top account represents a meaningful share of revenue, though the relationship is long standing and under contract. <span class="mk">4</span></div>
          </div>
          ...
          <div class="col">
            ...
            <table class="fin">
              ...
              <tr><td class="k">Revenue <span class="mk">2</span></td><td class="v">$118.4M</td></tr>
              <tr><td class="k">Revenue growth (YoY)</td><td class="v">14%</td></tr>
              <tr><td class="k">Gross margin</td><td class="v">38.2%</td></tr>
              <tr class="sub"><td class="k">Adjusted EBITDA <span class="mk">5</span></td><td class="v">$19.6M</td></tr>
            ...
            <div class="chartwrap">
              ...
              <div class="chart">
                <div class="bar"><div class="val">$91</div><div class="b" style="height:47%"></div><div class="cat">FY-2</div></div>
                <div class="bar"><div class="val">$104</div><div class="b" style="height:60%"></div><div class="cat">FY-1</div></div>
                <div class="bar"><div class="val">$118</div><div class="b" style="height:75%"></div><div class="cat">LTM</div></div>
                <div class="bar"><div class="val">$140</div><div class="b" style="height:100%"></div><div class="cat">Proj</div></div>
              </div>
            </div>
            ...
            <div class="foot-note">Note: Financial figures are unaudited management estimates; adjusted EBITDA reflects normalization adjustments detailed in the financial section <span class="mk">6</span></div>
          </div>
        </div>
      </div>
    ...
    <!-- ================= COMMENTS RAIL ================= -->
    <div class="rail">
      <div class="rh"><span>Comments</span><span class="n">6</span></div>

      <div class="cmt">
        <div class="av">DK</div>
        <div>
          <div class="top"><span class="num">1</span><span class="who">Danny</span><span class="role">Associate</span><span class="time">7:32 PM</span></div>
          <div class="txt">still a description, punch it. lead with the shelf position and the margin, not what they make.</div>
        </div>
      </div>
      ...
      <div class="cmt">
        <div class="av">DK</div>
        <div>
          <div class="top"><span class="num">2</span><span class="who">Danny</span><span class="role">Associate</span><span class="time">7:32 PM</span></div>
          <div class="txt">revenue doesn't tie, source it. this isn't the number off the model.</div>
        </div>
      </div>
      ...
      <div class="cmt">
        <div class="av">DK</div>
        <div>
          <div class="top"><span class="num">3</span><span class="who">Danny</span><span class="role">Associate</span><span class="time">7:33 PM</span></div>
          <div class="txt">rank these, don't list. two you'd defend in a room first, the rest underneath.</div>
        </div>
      </div>
      ...
      <div class="cmt">
        <div class="av">DK</div>
        <div>
          <div class="top"><span class="num">4</span><span class="who">Danny</span><span class="role">Associate</span><span class="time">7:34 PM</span></div>
          <div class="txt">reads defensive. frame the concentration, the relationship and the term, don't hedge it.</div>
        </div>
      </div>
      ...
      <div class="cmt">
        <div class="av">DK</div>
        <div>
          <div class="top"><span class="num">5</span><span class="who">Danny</span><span class="role">Associate</span><span class="time">7:35 PM</span></div>
          <div class="txt">every add-back needs a half line of why. a buyer reads this hunting for the soft one.</div>
        </div>
      </div>
      ...
      <div class="cmt">
        <div class="av">DK</div>
        <div>
          <div class="top"><span class="num">6</span><span class="who">Danny</span><span class="role">Associate</span><span class="time">7:36 PM</span></div>
          <div class="txt">footnote's missing its period, and tie the source line back to the schedule.</div>
        </div>
      </div>
    </div>
  </div>

  <div class="hint">Mock for render-fidelity review only. The red numbered markers on the slide correspond to Danny's numbered comments in the review pane. Not wired to anything.</div>
</div>
</body>
</html>
`
