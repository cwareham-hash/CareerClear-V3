// Meridian Park artifact 07 - GapsFirstDraft. Self-contained HTML,
// verbatim from content repo artifacts/artifact_07_GapsFirstDraft.html. Do not edit the markup.
// Rendered in a sandboxed iframe by components/simulation/HtmlArtifact.tsx.
// Manifest type powerpoint, which the app renders at powerpoint width. Placement: Block 10 master / DITL Block 5, Deck section build.

export const meridianArtifact07Html = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Meridian Park Investor Platform Assessment - Section 3, the gaps</title>
<style>
  :root{
...
<div class="atitle">The Meridian portal delivers accurate data but stops short of the finished output investors need, leaving them to build the last mile by hand</div>
<div class="asub">Investors consistently credit the accuracy and completeness of the data on the portal, and just as consistently describe the manual work they do afterwards to turn that data into the finished output their boards, committees and internal systems actually require.</div>
<div class="cols"><div class="cl"><ul class="b">
<li>Across the 18 investor interviews completed to date, nearly all credit the portal's data as accurate and complete, and nearly all describe doing manual work to turn that data into what they actually use.</li>
<li>The pain is not accuracy. It is the gap between accurate data and a usable end product.</li></ul>
<div class="qt">"I'm paying for a finished product and getting raw ingredients."</div>
<div class="qt">"It gives me a PDF I have to take apart before any of the real work starts."</div>
</div><div class="cr"><svg width="352" height="228" viewBox="0 0 352 228" role="img" aria-label="Accurate data, the gap, finished output">
...
<text x="176" y="190" font-family="Arial,Helvetica,sans-serif" font-size="10" fill="#56637a" text-anchor="middle">today the investor closes this gap</text></svg></div></div>
<div class="sowhat"><b>So what:</b> the opportunity is the last mile, not the data layer. This reframes the problem from fix the data to finish the job.</div>
</div><div class="sfoot"><span class="src">Source: investor interview programme, 18 interviews completed to date. Quotes unattributed by design.</span><span class="rt"><span class="draft">Draft</span><span class="conf">Confidential, prepared for Meridian Park</span><span class="pg">3.1</span></span></div></div></div>
<div class="row"><div class="slide"><div class="shdr"><span class="eng">Meridian Park Investor Platform Assessment</span><span class="strack"><span class="t">1 Current state</span><span class="d"></span><span class="t">2 Future state</span><span class="d"></span><span class="t on">3 The gaps</span><span class="d"></span><span class="t">4 Roadmap</span></span></div><div class="sbody">
<div class="atitle only">The last mile takes a different shape by investor type: pensions need board-ready documents, insurers need system-ready data</div>
<div class="cols"><div class="cl"><ul class="b">
<li>Document-led investors (pensions, endowments, foundations): the missing last step is a consolidated, presentation-ready report they can take to a board or investment committee.<ul><li>A pension CIO rebuilds a quarter's capital activity by hand because there is no consolidated capital-activity report. About 1 to 2 analyst-days per quarter on assembly alone, before anyone analyzes the numbers.</li></ul></li>
<li>Data-led investors (insurers): the missing last step is structured data delivered into their own systems for statutory accounting, regulatory capital, and asset-liability work. A PDF is of little use.<ul><li>A life insurer reclassifies and re-keys every position so it maps to statutory reporting. About 2 staff for the better part of a week each quarterly filing.</li></ul></li>
...
</div><div class="sfoot"><span class="src">Source: investor interview programme, 18 interviews completed to date. Quantification is investor-reported.</span><span class="rt"><span class="draft">Draft</span><span class="conf">Confidential, prepared for Meridian Park</span><span class="pg">3.2</span></span></div></div></div>
<div class="row"><div class="slide"><div class="shdr"><span class="eng">Meridian Park Investor Platform Assessment</span><span class="strack"><span class="t">1 Current state</span><span class="d"></span><span class="t">2 Future state</span><span class="d"></span><span class="t on">3 The gaps</span><span class="d"></span><span class="t">4 Roadmap</span></span></div><div class="sbody">
...
<div class="pnote">The data feed and look-through gap for data-led investors is carried on its own page given the wider score spread.</div>
</div><div class="sfoot"><span class="src">Source: investor interview programme, 18 interviews completed to date. Quantification is investor-reported.</span><span class="rt"><span class="draft">Draft</span><span class="conf">Confidential, prepared for Meridian Park</span><span class="pg">3.3</span></span></div></div></div></div>
</body>
</html>
`
